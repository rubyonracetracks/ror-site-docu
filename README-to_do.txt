...
3.  In the website/package.json file, add a test entry to the scripts section.  Add a comma after the last entry.  After this comma, add the line '"test": "npm build"'.
4.  After you are finished, enter the command "exit" to close this third tmux window.
5.  In the second tmux window, enter the command "sh git_check.sh".  After you see that all tests pass, commit the changes. 
